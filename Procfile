...
urgent_task_worker: env TERM_CHILD=1 RESQUE_TERM_TIMEOUT=9 QUEUE=charge_request_updater_queue,call_data_record_creator_queue,message_processor_queue,twilio_cdr_fetcher_queue,delivery_receipt_creator_queue,dialer_queue bundle exec rake resque:work
